...
# Another Example
- The Problem: Imagine a lamp where the power cord is hardwired directly into the copper wiring inside your house's walls. If you want to change the lamp, or if the lamp breaks, you have to rip open the wall. The lamp and the house are tightly coupled.

- The Inversion: Instead of hardwiring, we introduce an agreement (an interface): the wall outlet. The house provides an outlet, and the lamp plugs into the outlet. Now, the house doesn't care what kind of lamp you use, as long as it has the right plug. You have inverted the dependency.
...
```
Full file: [GoodExample](GoodExample.java)
