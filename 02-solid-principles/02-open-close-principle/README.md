...
- Main Running Code: In main function, we create the appropriate tax calculator and inject it into the Invoice class, making the system easily extensible for new regions.
